...
author_image_url: https://images.unsplash.com/photo-1682091036572-b90b02dd347e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=764&q=80
...
```js[class="line-numbers"][data-line="1,2"]
function hello() {
  console.log('Hello')
}
```
